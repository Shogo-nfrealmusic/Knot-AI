  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 items-center justify-center h-full relative">
        <div className="message absolute left-10 top-10 rounded-full border border-neutral-200 bg-white px-4 py-2 text-neutral-700 shadow-[0_1px_2px_rgba(0,0,0,0.05),0_8px_16px_-8px_rgba(0,0,0,0.12)]">
          <p className="text-xs">Payment captured</p>
        </div>
        <svg
          width="335"
          height="163"
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.571573" stopColor="#3b82f6" stopOpacity="0.9" />
        ...
        >
          ...
          <circle cx="18" cy="154" r="5" fill="#3b82f6" />
          <defs>
            <filter
